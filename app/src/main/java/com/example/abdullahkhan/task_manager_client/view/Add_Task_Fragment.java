 ...
 * {@link Add_Task_Fragment.OnFragmentInteractionListener} interface
...
//        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        Button addButton = (Button) view.findViewById(R.id.delete_button);
        TextView timeTextView = (TextView) view.findViewById(R.id.time_textView);
        EditText descriptionEditText = (EditText) view.findViewById(R.id.description_textView);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onButtonPressed(descriptionEditText.getText().toString());
            }
        });
    }

    // TODO: Rename method, update argument and hook method into UI event
    public void onButtonPressed(String description) {
        if (mListener != null) {
            mListener.addTask(description);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void addTask(String decription);
    }
}
